...
class DesiredOutputFormat {
    ...
    public addNode1(node: Annotation){
...
function mouseUp() {
    ...
    pointULCounter++;
    let pointUL = {pointID: "PointUL"+pointULCounter, x: rect.startX, y: rect.startY};
    pointLRCounter++;
    let pointLR = {pointID: "PointLR"+pointLRCounter, x: rect.startX+rect.w, y: rect.startY+rect.h};
    objectCounter++;
    let node = {annotationID: "Object"+objectCounter, upperLeft: pointUL, lowerRight: pointLR, type};
...
function addNode(node: Annotation) {
